...
import { GraduationCap, BookOpen, FolderPlus, FileText, Compass } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        ...
        <aside className="w-64 bg-white border-r border-gray-200 min-h-[calc(100vh-88px)]">
