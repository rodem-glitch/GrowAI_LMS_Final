...
if(true)return;
  ...
  if( sReplyCd.equals("0000") ){
    ...
    out.println("주문번호               : " + Malgn.htt(sOrderNo)          + "<br>");
    out.println("승인금액               : " + Malgn.htt(sAmt)              + "<br>");
    out.println("지불수단               : " + Malgn.htt(sPayType)          + "<br>");
    out.println("승인일시               : " + Malgn.htt(sApprovalYmdHms)   + "<br>");
    out.println("거래일련번호           : " + Malgn.htt(sSeqNo)            + "<br>");
    out.println("에스크로 적용 여부     : " + Malgn.htt(sEscrowYn)         + "<br>");
    out.println("==================== 신용 카드 ===================<br>");
    out.println("승인번호               : " + Malgn.htt(sApprovalNo)       + "<br>");
    out.println("카드ID                 : " + Malgn.htt(sCardId)           + "<br>");
    out.println("카드명                 : " + Malgn.htt(sCardNm)          + "<br>");
    out.println("할부개월               : " + Malgn.htt(sSellMm)          + "<br>");
    out.println("무이자여부             : " + Malgn.htt(sZerofeeYn)        + "<br>");   //무이자(Y),일시불(N)
    out.println("인증여부               : " + Malgn.htt(sCertYn)         + "<br>");   //인증(Y),미인증(N)
    out.println("직가맹여부             : " + Malgn.htt(sContractYn)       + "<br>");   //3자가맹점(Y),대표가맹점(N)
    out.println("세이브 결제 금액       : " + Malgn.htt(sSaveAmt)          + "<br>");
    out.println("포인트 결제 금액       : " + Malgn.htt(sPointAmt)         + "<br>");
    out.println("=============== 계좌 이체 / 가상계좌 =============<br>");
    out.println("은행ID                 : " + Malgn.htt(sBankId)           + "<br>");
    out.println("은행명                 : " + Malgn.htt(sBankNm)           + "<br>");
    out.println("현금영수증 일련 번호   : " + Malgn.htt(sCashBillNo)       + "<br>");
    out.println("현금영수증 승인 번호   : " + Malgn.htt(sCashApprovalNo)   + "<br>");
    out.println("===================== 가상계좌 ===================<br>");
    out.println("계좌번호               : " + Malgn.htt(sAccountNo)        + "<br>");
    out.println("입금 계좌명            : " + Malgn.htt(sIncomeAccNm)     + "<br>");
    out.println("입금자명               : " + Malgn.htt(sAccountNm)        + "<br>");
    out.println("입금기한일             : " + Malgn.htt(sIncomeLimitYmd)   + "<br>");
    out.println("입금예정일             : " + Malgn.htt(sIncomeExpectYmd)  + "<br>");
    out.println("현금영수증신청 여부    : " + Malgn.htt(sCashYn)          + "<br>");
    out.println("===================== 휴대폰 결제 ================<br>");
    out.println("이동통신사구분         : " + Malgn.htt(sHpId)            + "<br>");
    out.println("===================== 상품권 결제 ================<br>");
    out.println("상품권ID               :" + Malgn.htt(sTicketId)          + "<br>");
    out.println("상품권 이름            :" + Malgn.htt(sTicketPayType)     + "<br>");
    out.println("결제구분               :" + Malgn.htt(sTicketNm)        + "<br>");
    ...
    out.println("신용카드 부분취소가능여부 : " + Malgn.htt(sPartcancelYn)  + "<br>");
    out.println("BC인증번호                : " + Malgn.htt(sBCCertNo)      + "<br>");
    out.println("카드번호 Return           : " + Malgn.htt(sCardNo)        + "<br>");
    out.println("ISP 전체 카드코드         : " + Malgn.htt(sIspFullCardCd) + "<br>");
    out.println("카드구분                  : " + Malgn.htt(sCardType)      + "<br>");
    out.println("계좌이체 예금주명         : " + Malgn.htt(sBankAccountNm) + "<br>");
	//////////////////////////////////////////////////////////////////////
