...
DataSet list = course.query(
    " SELECT c.id course_id, c.course_nm, c.onoff_type, c.mobile_yn, cl.chapter, cl.twoway_url, cl.start_date, cl.start_time, cl.end_time, l.id lesson_id, l.lesson_nm, l.lesson_type, l.content_width, l.content_height "
...
while(list.next()) {
    ...
    list.put("study_time_conv", m.time("yyyy-MM-dd", list.s("start_date")) + "<br/>" + list.s("start_time_conv") + " - " + list.s("end_time_conv"));
    list.put("mobile_block", list.b("mobile_yn"));
}

//출력
p.setLayout(ch);
p.setBody("mobile.course_lesson_list");
p.setVar("query", m.qs());
