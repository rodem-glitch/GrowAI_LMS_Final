...
String[] allowFields = new String[] {"a.course_nm", "a.content1", "a.content2"};
if(!Arrays.asList(allowFields).contains(sField)) sField = "";
if(!"".equals(sField)) lm.addSearch(sField, f.get("s_keyword"), "LIKE");
else lm.addSearch(m.join(",", allowFields), f.get("s_keyword"), "LIKE");

//정렬기준에 따라
lm.setOrderBy(!"".equals(ord) ? ord : "a.request_edate DESC");
