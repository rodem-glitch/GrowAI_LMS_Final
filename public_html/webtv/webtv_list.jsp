...
p.setVar("grade_title", Malgn.getItem(grade, webtv.grades));
p.setVar("term_title", Malgn.getItem(term, webtv.terms));
p.setVar("subject_title", Malgn.getItem(subject, webtv.subjects));
