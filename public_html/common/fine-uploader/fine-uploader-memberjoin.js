        ...
        qq.basePrivateApi = {
            ...
            _handleDeleteSuccess: function(id) {
                if (this.getUploads({
                    ...
                    this.log("'" + name + "' 삭제 요청이 성공했습니다.");
                }
            },
            _handleDeleteFailed: function(id, xhrOrXdr) {
                var name = this.getName(id);
                this._uploadData.setStatus(id, qq.status.DELETE_FAILED);
                this.log("'" + name + "' 삭제 요청이 실패했습니다.", "error");
    ...
    (function() {
        ...
        qq.FineUploaderBasic = function(o) {
            ...
            this._options = {
                ...
                messages: {
                    typeError: "{file} 파일은 허용되지 않는 형식입니다. ({extensions}).",
                    ...
                    tooManyItemsError: "너무 많은 항목이 ({netItems}) 업로드되었습니다. ({itemLimit} 항목 제한)",
