...
public class _call_0comment__jsp extends com.caucho.jsp.JavaPage
{
...
if(m.isPost()) {
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("comment/call_comment.jsp"), -4456487165681177321L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("comment/init.jsp"), -2928449078418155885L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
