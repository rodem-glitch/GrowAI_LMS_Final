...
public class _tutor_0menu_0list__jsp extends com.caucho.jsp.JavaPage
{
...
while(list.next()) {
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("tutor/tutor_menu_list.jsp"), 6430397156482650461L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("tutor/init.jsp"), -2167633101682832884L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
