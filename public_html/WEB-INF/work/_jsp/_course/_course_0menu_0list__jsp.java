...
public class _course_0menu_0list__jsp extends com.caucho.jsp.JavaPage
{
...
if(templateBlock && new File(tplRoot + "/" + m.replace(template, ".", "/") +  ".html").exists()) {
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("course/course_menu_list.jsp"), 2156422850871282044L, false);
    _caucho_depends.add(depend);
