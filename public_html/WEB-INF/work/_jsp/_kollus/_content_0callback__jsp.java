...
public class _content_0callback__jsp extends com.caucho.jsp.JavaPage
{
...
kollusFile.update("upload_file_key = '" + info.s("upload_file_key") + "'");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("kollus/content_callback.jsp"), -5482962461572501289L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("kollus/init.jsp"), 2689860979209965029L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
