...
package _jsp._sysop._certificate;
...
p.display();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/certificate/template_modify.jsp"), 6134570722114786649L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/certificate/init.jsp"), -2656376710326673248L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
