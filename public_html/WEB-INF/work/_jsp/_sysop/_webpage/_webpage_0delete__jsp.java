...
public class _webpage_0delete__jsp extends com.caucho.jsp.JavaPage
{
...
m.jsReplace("webpage_list.jsp?" + m.qs("id,mode"));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/webpage/webpage_delete.jsp"), -8070252055068578910L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/webpage/init.jsp"), -7162420496711387185L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
