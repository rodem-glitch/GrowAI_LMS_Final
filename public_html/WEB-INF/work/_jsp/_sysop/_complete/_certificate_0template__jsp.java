...
out.print(tbody);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/complete/certificate_template.jsp"), -2885410832641203205L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/complete/init.jsp"), 4867222188672443604L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
