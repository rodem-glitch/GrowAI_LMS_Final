...
public class _menu_0grant_0insert__jsp extends com.caucho.jsp.JavaPage
{
...
out.print("<script>parent.window.close();</script>");
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/menu/menu_grant_insert.jsp"), 2546183571075797161L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/menu/init.jsp"), -7477956251603596681L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
