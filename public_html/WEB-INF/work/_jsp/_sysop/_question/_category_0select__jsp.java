...
public class _category_0select__jsp extends com.caucho.jsp.JavaPage
{
...
p.display();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/question/category_select.jsp"), 6050366042563416752L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/question/init.jsp"), -7162420496711387185L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/init.jsp"), 2621209624171497869L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
  }
