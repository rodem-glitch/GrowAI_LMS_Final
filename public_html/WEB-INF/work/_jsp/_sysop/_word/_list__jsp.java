...
p.display();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/word/list.jsp"), 4839087585529853229L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/word/init.jsp"), 8438494149736086439L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
