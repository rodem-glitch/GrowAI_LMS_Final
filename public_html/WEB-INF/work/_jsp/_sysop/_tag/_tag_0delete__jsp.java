...
public class _tag_0delete__jsp extends com.caucho.jsp.JavaPage
{
...
m.jsReplace("../tag/tag_list.jsp?" + m.qs("id"));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/tag/tag_delete.jsp"), 7330882602942783207L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/tag/init.jsp"), 1783350337642642501L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
