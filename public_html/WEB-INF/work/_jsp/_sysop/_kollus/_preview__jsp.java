...
//m.redirect(url + "&uservalue0=" + (-1 * userId) + "&uservalue1=-99&uservalue2=-99&uservalue3=" + m.encrypt(siteId + sysToday + userId, "SHA-256"));
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/kollus/preview.jsp"), -8248806430915241516L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("sysop/kollus/init.jsp"), -7162420496711387185L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
