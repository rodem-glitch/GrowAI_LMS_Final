...
public class _course_0mov_0api__jsp extends com.caucho.jsp.JavaPage
{
...
Aes256 aes = new Aes256();
	System.out.println("=====>"+ Base64.getDecoder().decode(token));
...
apiLog.printList(out, _ret, list);
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("api/course_mov_api.jsp"), 1887951994975605884L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("api/init.jsp"), 2409990678791882903L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
