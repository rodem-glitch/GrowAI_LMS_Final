...
public class _book_0list__jsp extends com.caucho.jsp.JavaPage
{
...
String ch = m.rs("ch", "book");
if("".equals(ch)) ch = "book";
...
p.display();
    ...
    throws javax.servlet.ServletException
  {
    ...
    depend = new com.caucho.vfs.Depend(appDir.lookup("book/book_list.jsp"), 4121085725843207473L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
    depend = new com.caucho.vfs.Depend(appDir.lookup("book/init.jsp"), -8900795106243690356L, false);
    _caucho_depends.add(depend);
    loader.addDependency(depend);
