...
lm.setFields("b.*, a.id coupon_user_id, a.use_yn, a.use_date, c.course_nm, oi.id order_item_id");
...
while(list.next()) {
    ...
    list.put("cancel_block", 0 < list.i("order_item_id"));

    list.put("use_conv", list.b("use_yn") ? "사용" : "미사용");
    list.put("use_conv", list.b("use_yn") ? (list.b("cancel_block") ? "주문중" : "사용") : "미사용");
}
