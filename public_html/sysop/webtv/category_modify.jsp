...
//정보
DataSet info = category.find("id = " + id + " AND status = 1 AND module = 'webtv' AND site_id = " + siteId + "");
...
//정보-상위
DataSet pinfo = category.find("id = " + pid + " AND status = 1 AND module = 'webtv' AND site_id = " + siteId +"");
...
f.addElement("hit_cycle", info.i("hit_cycle"), "hname:'조회수 갱신주기', required:'Y', option:'number', min:'0', max:'999'");
