...
//게시물에 파일종류 업데이트
if(module.equals("webtv") && moduleId > 0) webtv.updateFileCount(moduleId);
...
p.setVar("tgt", tgt);
p.setVar("contentwidth", webtv.getContentWidth() - 20);
p.display();
