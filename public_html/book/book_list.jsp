...
//정렬기준에 따라
if(!"".equals(ord) && m.inArray(m.replace(ord, " ", ""), "a.id asc,a.id desc,a.pub_date asc,a.pub_date desc,a.sort asc,a.sort desc,a.allsort asc,a.allsort desc,a.recomm_yn asc,a.recomm_yn desc,a.book_nm asc,a.book_nm desc")) {
	lm.setOrderBy(ord);
} else {
